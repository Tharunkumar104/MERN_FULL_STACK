function func() {
    ...
    localStorage.setItem("name", "Tharunkumar");
    localStorage.setItem("passsword", "Tharun@104");
    ...
    sessionStorage.setItem("name", "Tharunkumar");
    sessionStorage.setItem("passsword", "Tharun@104");
    ...
    body.innerHTML = "<h2>Welcome Tharunkumar</h2>";
    ...
    newele.innerText = "Tharun"  //h1 is the tag name  
...
function funct() {
    let body = document.getElementById("dom1");
    console.log(body);
